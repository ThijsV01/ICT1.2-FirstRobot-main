...
public class SimpleMqttClient : IDisposable
{
    ...
    public SimpleMqttClient(SimpleMqttClientConfiguration options)
    {
        ...
        _client = new HiveMQClient(new()
        {
            ...
            Password = new NetworkCredential("", options.Password).SecurePassword
        });
    ...
    public static SimpleMqttClient CreateSimpleMqttClientForHiveMQ(string clientId)
    {
        ...
        {
            Host = "eb037ef1d5bd4d6c9e125a4c1d849a1a.s1.eu.hivemq.cloud", // maak eventueel een account aan bij hivemq als dit problemen geeft.
            Port = 8883,
            ...
            UserName = "hivemq.webclient.1764263668882",
            Password = "sG64!U28,nkEAVme<%fZ"
        });
